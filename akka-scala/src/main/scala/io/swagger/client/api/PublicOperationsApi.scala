...
object PublicOperationsApi {
  ...
  def searchInventory(searchString: Option[String] = None, skip: Option[Int] = None, limit: Option[Int] = None): ApiRequest[Seq[InventoryItem]] =
    ApiRequest[Seq[InventoryItem]](ApiMethods.GET, "https://dev-virtserver.swaggerhub.com/fbmattos/atest2/1.0.0", "/inventory", "application/json")
